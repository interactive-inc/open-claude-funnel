...
export function App(props: Props) {
  ...
  const runListenerAction = async (action: "start" | "stop" | "restart") => {
    ...
    if (action === "start") await props.funnel.listeners.start(entry.name);
    if (action === "stop") await props.funnel.listeners.stop(entry.name);
    if (action === "restart") await props.funnel.listeners.restart(entry.name);
